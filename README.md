...
# 👋 Hey, je suis **Jules ADONSI**
### 🚀 Backend Developer & Android Engineer · 🌍 Bénin
...
### 👨‍💻 Langages
![Python](https://skillicons.dev/icons?i=python,java,javascript,typescript,kotlin)

### ⚙️ Backend
![Backend](https://skillicons.dev/icons?i=django,fastapi,nodejs,spring)

### 📱 Mobile Android
![Mobile](https://skillicons.dev/icons?i=androidstudio,kotlin)

### 🗄️ Bases de données & Cache
![DB](https://skillicons.dev/icons?i=postgres,redis)
...
*⭐ Si un de mes projets t'a été utile, une étoile est toujours appréciée !*

![Visitor Count](https://komarev.com/ghpvc/?username=julesadonsi&style=for-the-badge&color=00D9FF)
